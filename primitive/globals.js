...
const childrenRoomColors = {
  soft_coral: "#FF9AA2",
  light_salmon_pink: "#FFB7B2",
  peach_crayola: "#FFDAC1",
  tea_green: "#E2F0CB",
  magic_mint: "#B5EAD7",
  periwinkle_crayola: "#C7CEEA",
  bright_gold: "#FFD700",
  banana_mania: "#FDDB3A",
  ...
  pastel_gray: "#CFCFC4",
  bright_purple: "#A23BEC"
};
const vibrantColors = {
  bright_red: "#FF4057",
  vivid_teal: "#00B8A9",
  vibrant_orange: "#F46036",
  strong_carmine: "#E71D36",
  bright_turquoise: "#2EC4B6",
  sunny_yellow: "#FFD166",
  neon_green: "#06D6A0",
  fuchsia_pink: "#EF476F",
  cobalt_blue: "#26547C",
  electric_orange: "#FF9F1C",
  bright_sky_blue: "#00BBF9",
  blue_ncs: "#118AB2",
  dark_cyan: "#073B4C",
  bright_yellow: "#FFD32D",
  electric_purple: "#8338EC",
  tango_orange: "#FB5607",
  neon_pink: "#FF006E",
  vivid_blue: "#3A86FF",
  bitter_lemon: "#FFBE0B",
  ...
  blue_yonder: "#577590",
  lavender_purple: "#9B5DE5",
  light_magenta: "#F15BB5",
  electric_yellow: "#FEE440",
  bright_cyan: "#00F5D4",
...
const dicolor = {
  ...
  cyanblue: {
    ...
    jordy_blue: "#8ab9f1",
    lapis_lazuli: "#26619c",
    lapis_lazuli_color_ruri_iro: "#1f4788",
    light_azure: "#66ccff",
  ...
  green: {
    ...
    whitish_green_byakuroku: "#a5ba93",
    xanadu: "#738678",
    xbox_green: "#0e7a0d",
    yellow_green: "#30b21a",
    young_bamboo: "#6b9362",
  ...
  orange: {
    alloy_orange: "#c46210",
    almond: "#efdecd",
    aloewood_color_kyara_iro: "#6a432d",
    amber_kohaku_iro: "#ca6924",
    amber_saeece: "#ff7e00",
    ...
    gold_crayola: "#e6be8a",
    golden_brown: "#996515",
    golden_brown_kincha: "#c66b27",
    golden_fallen_leaves: "#e29c45",
    golden_grey_bamboo: "#7d4e2d",
    golden_oak_kitsurubami: "#bb8141",
    grullo: "#a99a86",
    harvest_gold: "#da9100",
    heat_wave: "#ff7a00",
    iced_tea: "#923c01",
    ...
    liver_dogs: "#b86d29",
    loquat_tree_brown_biwacha: "#ab6134",
    lumber: "#ffe4cd",
    lye_colored_aku_iro: "#7f6b5d",
    ...
    mocha: "#bea493",
    mousy_indigo_ainezumi: "#5c544e",
    mud: "#70543e",
    mulberry_dyed_kuwazome: "#c57f2e",
    ...
    yellow_sea_pine_brown_kimirucha: "#896c39",
  ...
  orangeyellow: {
    ...
    pale_oak_aoshirotsurubami: "#bba46d",
